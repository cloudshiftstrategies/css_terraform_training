...
* HCL 0.12 was released in May 2019 and provides some significant improvements in usability and readability
...
Local values are like variables, but can be assigned with an expression.
